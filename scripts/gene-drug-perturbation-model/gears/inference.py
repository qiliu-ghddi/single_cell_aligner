...
def compute_metrics(results,gene_idx=None):
        ...
        if pert != 'ctrl':
            ...
            for m, fct in metric2fct.items():
                if m == 'pearson':
                    ...
                    val20 = fct(results['pred_de20'][p_idx].mean(0), results['truth_de20'][p_idx].mean(0))[0]
                    val50 = fct(results['pred_de50'][p_idx].mean(0), results['truth_de50'][p_idx].mean(0))[0]
                    val100 = fct(results['pred_de100'][p_idx].mean(0), results['truth_de100'][p_idx].mean(0))[0]
                    val200 = fct(results['pred_de200'][p_idx].mean(0), results['truth_de200'][p_idx].mean(0))[0]
                    #valall = fct(results['pred_deall'][p_idx].mean(0), results['truth_deall'][p_idx].mean(0))[0]

                    valdelta = fct(results['pred_de'][p_idx].mean(0) - results['ctrl_de'][p_idx].mean(0), results['truth_de'][p_idx].mean(0)-results['ctrl_de'][p_idx].mean(0))[0]
                    valdelta20 = fct(results['pred_de20'][p_idx].mean(0) - results['ctrl_de20'][p_idx].mean(0), results['truth_de20'][p_idx].mean(0)-results['ctrl_de20'][p_idx].mean(0))[0]
                    valdelta50 = fct(results['pred_de50'][p_idx].mean(0) - results['ctrl_de50'][p_idx].mean(0), results['truth_de50'][p_idx].mean(0)-results['ctrl_de50'][p_idx].mean(0))[0]
                    valdelta100 = fct(results['pred_de100'][p_idx].mean(0) - results['ctrl_de100'][p_idx].mean(0), results['truth_de100'][p_idx].mean(0)-results['ctrl_de100'][p_idx].mean(0))[0]
                    valdelta200 = fct(results['pred_de200'][p_idx].mean(0) - results['ctrl_de200'][p_idx].mean(0), results['truth_de200'][p_idx].mean(0)-results['ctrl_de200'][p_idx].mean(0))[0]
                    #valdeltaall = fct(results['pred_deall'][p_idx].mean(0) - results['ctrl_deall'][p_idx].mean(0), results['truth_deall'][p_idx].mean(0)-results['ctrl_deall'][p_idx].mean(0))[0]
                    if np.isnan(val):
                        val = 0
                    if np.isnan(val20):
                        val20 = 0
                    ...
                    if np.isnan(valdelta):
                        valdelta = 0
                    if np.isnan(valdelta20):
                        valdelta20 = 0
                    if np.isnan(valdelta50):
                        valdelta50 = 0
                    if np.isnan(valdelta100):
                        valdelta100 = 0
                    if np.isnan(valdelta200):
                        valdelta200 = 0
                    #if np.isnan(valdeltaall):
                    #    valdeltaall = 0
                   
                else:
                    val = fct(results['pred_de'][p_idx].mean(0), results['truth_de'][p_idx].mean(0))
                    val20 = fct(results['pred_de20'][p_idx].mean(0), results['truth_de20'][p_idx].mean(0))
                    val50 = fct(results['pred_de50'][p_idx].mean(0), results['truth_de50'][p_idx].mean(0))
                    val100 = fct(results['pred_de100'][p_idx].mean(0), results['truth_de100'][p_idx].mean(0))
                    val200 = fct(results['pred_de200'][p_idx].mean(0), results['truth_de200'][p_idx].mean(0))
                    #valall = fct(results['pred_deall'][p_idx].mean(0), results['truth_deall'][p_idx].mean(0))
                    
                    
                    valdelta = fct(results['pred_de'][p_idx].mean(0) - results['ctrl_de'][p_idx].mean(0), results['truth_de'][p_idx].mean(0)-results['ctrl_de'][p_idx].mean(0))
                    valdelta20 = fct(results['pred_de20'][p_idx].mean(0) - results['ctrl_de20'][p_idx].mean(0), results['truth_de20'][p_idx].mean(0)-results['ctrl_de20'][p_idx].mean(0))
                    valdelta50 = fct(results['pred_de50'][p_idx].mean(0) - results['ctrl_de50'][p_idx].mean(0), results['truth_de50'][p_idx].mean(0)-results['ctrl_de50'][p_idx].mean(0))
                    valdelta100 = fct(results['pred_de100'][p_idx].mean(0) - results['ctrl_de100'][p_idx].mean(0), results['truth_de100'][p_idx].mean(0)-results['ctrl_de100'][p_idx].mean(0))
                    valdelta200 = fct(results['pred_de200'][p_idx].mean(0) - results['ctrl_de200'][p_idx].mean(0), results['truth_de200'][p_idx].mean(0)-results['ctrl_de200'][p_idx].mean(0))
                    #valdeltaall= fct(results['pred_deall'][p_idx].mean(0) - results['ctrl_deall'][p_idx].mean(0), results['truth_deall'][p_idx].mean(0)-results['ctrl_deall'][p_idx].mean(0))
                   
                metrics_pert[pert][m + '_de'] = val
                metrics[m + '_de'].append(metrics_pert[pert][m + '_de'])

                metrics_pert[pert][m + '_de20'] = val20
                metrics[m + '_de20'].append(metrics_pert[pert][m + '_de20'])

                metrics_pert[pert][m + '_de50'] = val50
                metrics[m + '_de50'].append(metrics_pert[pert][m + '_de50'])

                metrics_pert[pert][m + '_de100'] = val100
                metrics[m + '_de100'].append(metrics_pert[pert][m + '_de100'])

                metrics_pert[pert][m + '_de200'] = val200
                metrics[m + '_de200'].append(metrics_pert[pert][m + '_de200'])

                #metrics_pert[pert][m + '_deall'] = valall
                #metrics[m + '_deall'].append(metrics_pert[pert][m + '_deall'])

                metrics_pert[pert][m + '_delta'] = valdelta
                metrics[m + '_delta'].append(metrics_pert[pert][m + '_delta'])

                metrics_pert[pert][m + '_delta20'] = valdelta20
                metrics[m + '_delta20'].append(metrics_pert[pert][m + '_delta20'])

                metrics_pert[pert][m + '_delta50'] = valdelta50
                metrics[m + '_delta50'].append(metrics_pert[pert][m + '_delta50'])

                metrics_pert[pert][m + '_delta100'] = valdelta100
                metrics[m + '_delta100'].append(metrics_pert[pert][m + '_delta100'])

                metrics_pert[pert][m + '_delta200'] = valdelta200
                metrics[m + '_delta200'].append(metrics_pert[pert][m + '_delta200'])

                #metrics_pert[pert][m + '_deltaall'] = valdeltaall
                #metrics[m + '_deltaall'].append(metrics_pert[pert][m + '_deltaall'])

        else:
            for m, fct in metric2fct.items():
                metrics_pert[pert][m + '_de'] = 0
                metrics_pert[pert][m + '_de20'] = 0
                metrics_pert[pert][m + '_de50'] = 0
                metrics_pert[pert][m + '_de100'] = 0
                metrics_pert[pert][m + '_de200'] = 0
                metrics_pert[pert][m + '_deall'] = 0
                metrics_pert[pert][m + '_delta'] = 0
                metrics_pert[pert][m + '_delta20'] = 0
                metrics_pert[pert][m + '_delta50'] = 0
                metrics_pert[pert][m + '_delta100'] = 0
                metrics_pert[pert][m + '_delta200'] = 0
                #metrics_pert[pert][m + '_deltaall'] = 0
    ...
    for m in metric2fct.keys():
        ...
        metrics[m + '_de20'] = np.mean(metrics[m + '_de20'])
        metrics[m + '_de50'] = np.mean(metrics[m + '_de50'])
        metrics[m + '_de100'] = np.mean(metrics[m + '_de100'])
        metrics[m + '_de200'] = np.mean(metrics[m + '_de200'])
        #metrics[m + '_deall'] = np.mean(metrics[m + '_deall'])

        metrics[m + '_delta'] = np.mean(metrics[m + '_delta'])
        metrics[m + '_delta20'] = np.mean(metrics[m + '_delta20'])
        metrics[m + '_delta50'] = np.mean(metrics[m + '_delta50'])
        metrics[m + '_delta100'] = np.mean(metrics[m + '_delta100'])
        metrics[m + '_delta200'] = np.mean(metrics[m + '_delta200'])
        #metrics[m + '_deltaall'] = np.mean(metrics[m + '_deltaall'])
...
def non_dropout_analysis(adata, test_res):
    ...
    for i, j in conditions2index.items():
        #.X.toarray
        try:
            condition2mean_expression[i] = np.mean(adata.X.toarray()[j], axis = 0)
        except:
            condition2mean_expression[i] = np.mean(adata.X[j], axis = 0)
    pert_list = np.array(list(condition2mean_expression.keys()))
    #.X.toarray()
...
def deeper_analysis(adata, test_res, de_column_prefix = 'rank_genes_groups_cov', most_variable_genes = None):
    ...
    for pert in np.unique(test_res['pert_cat']):
        ...
        # de_genes = adata.uns['rank_genes_groups_cov_all'][pert2pert_full_id[pert]]
        # adata_ = adata[adata.obs['condition'] == pert]
        # X = adata_.X
        # non_zero_cols = np.where(np.count_nonzero(X, axis=0) >= (X.shape[0] / 1.5))[0]
        # non_zero = non_zero_cols
        # depert = de_genes[pert]
        # gene_idx_top = [gene_id2idx[i] for i in depert]

        # non_zero_200 = [i for i in gene_idx_top if i in non_zero][:200]
        # de_idx_200 = np.array(non_zero_200)
        # non_zero_20 = [i for i in gene_idx_top if i in non_zero][:20]
        # de_idx = np.array(non_zero_20)
        # non_zero_100 = [i for i in gene_idx_top if i in non_zero][:100]
        # de_idx_100 = np.array(non_zero_100)
        # non_zero_50 = [i for i in gene_idx_top if i in non_zero][:50]
        # de_idx_50 = np.array(non_zero_50)
